...
define( "_AM_AVAMAN_UPLOAD" , "Invia immagini (E' anche possibile inviare più file contemporaneamente contenuti in un archivio zip o tar.gz)" ) ;
define( "_AM_AVAMAN_ERR_INVALIDARCHIVE" , "Archivio non valido. L'archivio non può essere aperto" ) ;

...
define('_ALBM_BTN_SELECTALL','Sélectionner  tout');
define('_ALBM_BTN_SELECTNONE','Sélectionner rien');
define('_ALBM_BTN_SELECTRVS','Sélection inverse');
define('_ALBM_FMT_PHOTONUM','%s pour chaque page');
define('_ALBM_AM_BUTTON_UPDATE','Modifier');
define('_ALBM_NOIMAGESPECIFIED','Erreur : aucune photos n\'a été transférée');
define('_ALBM_FILEREADERROR','Erreur : la photos n\'est pas lisible');
define('_ALBM_DIRECTCATSEL','Sélectionner une catégorie');
...
define( "_ALBM_RADIO_ROTATE180" , "Rotation de 180 degrés" ) ;
...
define("_ALBM_PHOTOCAT","Catégorie");
define("_ALBM_SELECTFILE","Selectionner la photo");
define("_ALBM_FILEERROR","Erreur : Photo non envoyée ou photo trop grande");
...
define("_ALBM_ANONNOTALLOWED","Les utilisateurs anonymes ne sont pas autorisés à écrire.");
...
define("_ALBM_AREYOUSURE","Êtes-vous sûr que vous voulez supprimer ce commentaire et tous ses descendants?");
...
define("_ALBM_EDITTHISPHOTO","Éditer cette Photo");

define("_ALBM_DESCRIPTIONC","Description: ");
define("_ALBM_EMAILC","Courriel: ");
define("_ALBM_CATEGORYC","Catégorie: ");
define("_ALBM_SUBCATEGORY","Sous-catégories: ");
...
define("_ALBM_CATEGORY","Catégorie");
...
define("_ALBM_CATEGORIES","Catégories");
...
define("_ALBM_NORATING","Aucun pointage sélectionné.");
...
define("_ALBM_CATEDIT","Ajouter, Modifier, et supprimer Catégories");
...
define("_ALBM_MODCAT","Modifier la Catégorie");
...
define("_ALBM_CATDELETED","Catégorie supprimée.");
define("_ALBM_CATDEL_WARNING","AVERTISSEMENT: Êtes vous sûr que vous vouler supprimer cette Catégorie et toutes ses photos et tous ses commentaires?");

...
Un nouvel événement "{EVENT_SUMMARY}" a été créé sur {X_SITENAME}.

Cliquez sur le lien pour voir cet événement :
{EVENT_URI}

-----------

Vous recevez ce message parce que vous avez demandé à être prévenu 
quand de nouveaux événements sont postés sur notre site..

...
define('_PICAL_ICON_DAILY','Vue journaliïÓe') ;
...
define('_PICAL_MB_PREV_WEEK','Semaine prñÄñÅente') ;
define('_PICAL_MB_NEXT_WEEK','Semaine suivante') ;
define('_PICAL_MB_PREV_MONTH','Mois prñÄñÅent') ;
define('_PICAL_MB_NEXT_MONTH','Mois suivant') ;
define('_PICAL_MB_PREV_YEAR','AnnñÆ prñÄñÅente') ;
define('_PICAL_MB_NEXT_YEAR','AnnñÆ suivante') ;

define("_PICAL_MB_NOEVENT","Pas d'ñ×ïÏements") ;
define('_PICAL_MB_ADDEVENT','Ajouter un ñ×ïÏement') ;
define('_PICAL_MB_CONTINUING','(continuer)') ;
define('_PICAL_MB_RESTEVENT_PRE','plus') ;
define('_PICAL_MB_RESTEVENT_SUF','ñÍñÎent(s)') ;
define('_PICAL_MB_TIMESEPARATOR','--') ;

define('_PICAL_MB_ALLDAY_EVENT','EvïÏement journalier') ;
...
define("_PICAL_MB_LINK_TO_RRULE1ST","Sauter jusqu'au premier ñ×ïÏement ") ;
define("_PICAL_MB_RRULE1ST","C'est le premier ñ×ïÏement") ;
...
define('_PICAL_MB_SUBTITLE_EVENTDETAIL','Vue des dñÕails') ;
define('_PICAL_MB_SUBTITLE_EVENTEDIT','Editer la vue') ;

define('_PICAL_MB_HOUR_SUF',':') ;
define('_PICAL_MB_MINUTE_SUF','') ;

define('_PICAL_TH_SUMMARY','RñÔumé') ;
define('_PICAL_TH_STARTDATETIME','Heure de dñÃut') ;
define('_PICAL_TH_ENDDATETIME','Heure de fin') ;
define('_PICAL_TH_ALLDAYOPTIONS','Options journaliïÓes') ;
...
define('_PICAL_TH_RRULE','PñÓiodicité') ;
define('_PICAL_TH_ADMISSIONSTATUS','Statut') ;

define("_PICAL_NTC_MONTHLYBYMONTHDAY","(NumñÓo d'entrñÆ)") ;
define('_PICAL_NTC_EXTRACTLIMIT','** Seulement %s ñ×ïÏements sont extraits en cas de maximum.') ;
define("_PICAL_NTC_NUMBEROFNEEDADMIT","(%s ñÍñÎents nñÄessitent l'approbation)") ;
...
define("_PICAL_ERR_LACKINDISPITEM","L'ñÍñÎent %s est vide.<br />Retournez en cliquant sur le bouton du browser") ;
...
define('_PICAL_RR_EVERYYEAR','Chaque annñÆ') ;
...
define('_PICAL_RR_FREQYEARLY_SUF','annñÆ(s)') ;
...
define('_PICAL_RR_S_NOTSELECTED','-non sñÍectionné-') ;
define('_PICAL_RR_S_SAMEASBDATE','Identique à la date de dñÃut') ;
define('_PICAL_RR_R_NOCOUNTUNTIL','Pas de conditions de fin') ;
define('_PICAL_RR_R_USECOUNT_PRE','rñÑñÕer') ;
...
define('_PICAL_MB_SHOWALLCAT','Toutes les catñÈories');
define('_PICAL_MB_ORDER_ASC','croissant');
define('_PICAL_MB_ORDER_DESC','dñÄroissant');
define('_PICAL_MB_SORTBY','Trié par:');
define('_PICAL_MB_CURSORTEDBY','Evenements actuellement triñÔ par:');
define('_PICAL_TH_CATEGORIES','Categories');
define('_PICAL_TH_LASTMODIFIED','DerniïÓe modification');
...
define('_PICAL_BTN_MOVE','DñÑlacer');

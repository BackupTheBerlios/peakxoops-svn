...
define('_AM_PI_TH_OPTIONS','Optionen (f—Ó gew‹Énlich leer)');
...
define('_AM_TH_SERVER_TZ_VALUE_TO','Changes (-14.0Ž¡ŽÁ14.0)');
...
define('_AM_OPT_PAST','fr—Éer');
define('_AM_OPT_FUTURE','spçÕer');
define('_AM_OPT_PASTANDFUTURE','fr—Éer&spçÕer');
...
define("_AM_CONFIRM_DELETE","L‹Ôchen - OK?");
define("_AM_CONFIRM_MOVE","Die Zuordnung zur alten Kategorie l‹Ôchen und zur angegebenen Kategorie hinzuf—Èen - OK?");
define("_AM_CONFIRM_COPY","Der ausgewçÉlten Kategorie zuordnen - OK?");
...
// admission
define("_AM_LABEL_ADMIT","AusgewçÉlte Termine: ");
...
define("_AM_ADMIT_TH4","Regeln f—Ó wiederkehrende Termine");
...
define("_AM_LABEL_IO_CHECKEDITEMS","AusgewçÉlte Termine:");
define("_AM_LABEL_IO_OUTPUT","werden im iCalendar ausgegeben");
define("_AM_LABEL_IO_SELECTPLATFORM","Plattform wçÉlen");
define("_AM_LABEL_IO_DELETE","werden gel‹Ôcht");
...
define("_AM_MES_DELETED","Termin(e) wurde(n) gel‹Ôcht");
define("_AM_IO_TH0","Benutzer");
define("_AM_IO_TH1","Start-Zeitpunkt");
define("_AM_IO_TH2","End-Zeitpunkt");
define("_AM_IO_TH3","Titel");
define("_AM_IO_TH4","Regeln f—Ó wiederkehrende Termine");
define("_AM_IO_TH5","Freigabe");

// Group's Permissions
define( '_AM_GPERM_G_INSERTABLE' , "d—Ófen hinzuf—Èen" ) ;
define( '_AM_GPERM_G_SUPERINSERT' , "d—Ófen uneingeschrçÏkt hinzuf—Èen" ) ;
define( '_AM_GPERM_G_EDITABLE' , "d—Ófen editieren" ) ;
define( '_AM_GPERM_G_SUPEREDIT' , "d—Ófen uneingeschrçÏkt editieren" ) ;
define( '_AM_GPERM_G_DELETABLE' , "d—Ófen l‹Ôchen") ;
define( '_AM_GPERM_G_SUPERDELETE' , "d—Ófen uneingeschrçÏkt l‹Ôchen" ) ;
define( '_AM_GPERM_G_TOUCHOTHERS' , "d—Ófen die Eingaben anderer Benutzer çÏdern" ) ;
define( '_AM_CAT2GROUPDESC' , "Kategorien auswçÉlen, zu denen Zugriff gewçÉrt werden soll" ) ;
define( '_AM_GROUPPERMDESC' , "Hier k‹Ïnen die Berechtigungen f—Ó jede Benutzergruppe einzeln eingestellt werden.<br />Um diese Funktion zu aktivieren, muss zuerst unter 'Einstellungen -> Berechtigungen f—Ó Benutzer' die Option 'Festgelegt durch Gruppenberechtigungen' ausgewçÉlt werden.<br />Anmerkung: Die Einstellungen f—Ó die beiden Gruppen 'Administratoren'(Webmasters) und 'GçÔte'(Anonymous Users) werden ignoriert." ) ;
...
define( '_AM_NOTICE_NOERRORS' , "Es existiert kein Fehler in den Tabellen oder EintrçÈen." ) ;
...
define( '_AM_CAT_TH_PARENT' , 'ŽÜbergeordnete Kategorie' ) ;
define( '_AM_CAT_TH_OPTIONS' , 'Optionen' ) ;
define( '_AM_CAT_TH_LASTMODIFY' , 'Letzte ŽÄnderung' ) ;
...
define( '_AM_FMT_CAT_DELETED' , '%s Kategorie(n) gel‹Ôcht' ) ;
define( '_AM_FMT_CAT_BATCHUPDATED' , '%s Kategorie(n) aktualisiert' ) ;
define( '_AM_FMT_CATDELCONFIRM' , 'Soll die Kategorie %s gel‹Ôcht werden?' ) ;

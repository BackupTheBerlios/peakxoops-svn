...
// titles
define("_AM_CONFIG","Configurações do piCal");
define("_AM_GENERALCONF","Configurações gerais");
define("_AM_ADMISSION","Aprovar eventos");
define("_AM_MENU_EVENTS","Administração de eventos");
define("_AM_MENU_CATEGORIES","Administração de categorias");
define("_AM_MENU_CAT2GROUP","Permissões de acesso das categorias");
define("_AM_ICALENDAR_IMPORT","Importar do iCalendar");
define("_AM_GROUPPERM","Permissões globais dos grupos");
define("_AM_TABLEMAINTAIN","Manutenção de tabelas (atualização)");
define("_AM_MYBLOCKSADMIN","Administração de blocos e grupos do piCal");
...
define("_AM_CONFIRM_DELETE","Você deseja realmente apagar o(s) evento(s)?");
define("_AM_CONFIRM_MOVE","Você deseja realmente apagar o link para categoria antiga e adicionar um link para a categoria especificada?");
define("_AM_CONFIRM_COPY","Você deseja realmente adicionar um link para a categoria especificada?");
...
define("_AM_ADMIT_TH1","Hora e data do início");
define("_AM_ADMIT_TH2","Hora e data do término");
define("_AM_ADMIT_TH3","Título");
define("_AM_ADMIT_TH4","Regras de repetição");

// iCalendar I/O

define("_AM_LABEL_IMPORTFROMWEB","Importar dados do iCalendar através da Web (insira uma URL começada por 'http://' ou 'webcal://')");
...
define("_AM_MES_EVENTLINKTOCAT","evento(s) foi(ram) conectado(s) à esta categoria.");
define("_AM_MES_EVENTUNLINKED","evento(s) com link à categoria antiga foi(ram) apagado(s).");
...
define("_AM_IO_TH1","Hora e data do início");
define("_AM_IO_TH2","Hora e data do término");
define("_AM_IO_TH3","Título");
define("_AM_IO_TH4","Regras de repetição");
define("_AM_IO_TH5","Aprovação");

// Group's Permissions
define( '_AM_GPERM_G_INSERTABLE' , "Permissão de criação de eventos" ) ;
define( '_AM_GPERM_G_SUPERINSERT' , "Permissão de aprovação de eventos" ) ;
define( '_AM_GPERM_G_EDITABLE' , "Permissão de edição de eventos" ) ;
define( '_AM_GPERM_G_SUPEREDIT' , "Permissão de aprovação de alterações de eventos" ) ;
define( '_AM_GPERM_G_DELETABLE' , "Permissão de exclusão de eventos" ) ;
define( '_AM_GPERM_G_SUPERDELETE' , "Permissão de aprovação de exclusão de eventos" ) ;
define( '_AM_GPERM_G_TOUCHOTHERS' , "Permissão de edição/remoção de eventos de outros" ) ;
define( '_AM_CAT2GROUPDESC' , "Marque as categorias às quais cada grupo terá permissão de acesso." ) ;
define( '_AM_GROUPPERMDESC' , "Dê as permissões do que cada grupo está autorizado a fazer com os eventos.<br />Para usar esta opção, antes você precisa definir as 'Permissões globais dos grupos'.<br />As configurações definidas aqui para o grupo dos administradores e anônimos serão ignoradas." ) ;

// Table Maintenance
define( '_AM_MB_SUCCESSUPDATETABLE' , "Estrutura das tabelas atualizadas com sucesso." ) ;
define( '_AM_MB_FAILUPDATETABLE' , "Não foi possível atualizar a estrutura das tabelas." ) ;
define( '_AM_NOTICE_NOERRORS' , "Atualização para o formato 0.6 concluída sem problemas." ) ;
...
define( '_AM_FMT_WRONGSTZ' , "Existem %s eventos com o fuso horário incorreto.<br />Deseja consertá-los?" ) ;

// Categories
define( '_AM_CAT_TH_TITLE' , 'Título' ) ;
define( '_AM_CAT_TH_DESC' , 'Descrição' ) ;
define( '_AM_CAT_TH_PARENT' , 'Categoria padrão' ) ;
...
define( '_AM_CAT_TH_WEIGHT' , 'Posição' ) ;
...
define( '_AM_FMT_CATDELCONFIRM' , 'Você deseja realmente apagar a categoria %s ?' ) ;

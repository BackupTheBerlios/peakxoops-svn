...
define("_MI_PICAL_DESC","Módulo de calendário com agenda.");

// Names of blocks for this module (Not all module has blocks)
define("_MI_PICAL_BNAME_MINICAL","Mini-calendário");
define("_MI_PICAL_BNAME_MINICAL_DESC","Mostra um mini-calendário em bloco.");
define("_MI_PICAL_BNAME_MONTHCAL","Calendário mensal em tamanho completo");
define("_MI_PICAL_BNAME_MONTHCAL_DESC","Mostra um calendário mensal em tamanho completo.");
...
define("_MI_PICAL_BNAME_THEDAYS_DESC","Mostra eventos do dia indicado no calendário.");
define("_MI_PICAL_BNAME_COMING","Próximos eventos");
define("_MI_PICAL_BNAME_COMING_DESC","Mostra os próximos eventos.");
define("_MI_PICAL_BNAME_AFTER","Eventos depois %s");
define("_MI_PICAL_BNAME_AFTER_DESC","Mostra os eventos após o dia indicado no calendário.");
...
define("_MI_PICAL_ADMENU1","Administração de eventos");
define("_MI_PICAL_ADMENU_CAT","Administração de categorias");
define("_MI_PICAL_ADMENU_CAT2GROUP","Permissões globais das categorias");
define("_MI_PICAL_ADMENU2","Permisões globais dos grupos");
define("_MI_PICAL_ADMENU_TM","Manutenção das tabelas");
define("_MI_PICAL_ADMENU_ICAL","Importar do iCalendar");
define('_MI_PICAL_ADMENU_MYBLOCKSADMIN','Administração de blocos e grupos');

// Text for notifications
define('_MI_PICAL_GLOBAL_NOTIFY', 'Global');
define('_MI_PICAL_GLOBAL_NOTIFYDSC', 'Opções globais de aviso do piCal.');
define('_MI_PICAL_CATEGORY_NOTIFY', 'Categoria');
define('_MI_PICAL_CATEGORY_NOTIFYDSC', 'Opções de aviso que se aplicam para a categoria atual.');
define('_MI_PICAL_EVENT_NOTIFY', 'Evento');
define('_MI_PICAL_EVENT_NOTIFYDSC', 'Opções de aviso que se aplicam para o evento atual.');
...
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} aviso automático: Novo evento');
...
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} aviso automático: Novo evento em {CATEGORY_TITLE}');

...
define('_MI_OPT_TZ_USEXOOPS','valor de la configuración de XOOPS');
...
define('_MI_PICAL_ADMENU_PLUGINS','Configuración de Plugins');
...
define('_MI_PICAL_LOCALE','Local (comprobación de los archivos locales/*.php)');
...
define("_MI_PICAL_DESC","Módulo de calendario con agenda de eventos");
...
define("_MI_PICAL_BNAME_THEDAYS_DESC","Muestra los eventos del día indicado");
define("_MI_PICAL_BNAME_COMING","Próximos eventos");
define("_MI_PICAL_BNAME_COMING_DESC","Muestra los próximos eventos");
define("_MI_PICAL_BNAME_AFTER","Eventos después %s");
define("_MI_PICAL_BNAME_AFTER_DESC","Muestra eventos después del día indicado");
...
define("_MI_MINICAL_TARGET", "Mostrar página en el centro cuando se hace clic en la fecha del minicalendario");
define("_MI_COMING_NUMROWS", "Número de eventos que se muestran el el bloque de próximos eventos");
define("_MI_SKINFOLDER", "Nombre del folder de la piel(Skin)");
define("_MI_SUNDAYCOLOR", "Color del Domingo");
define("_MI_WEEKDAYCOLOR", "Color de los días de la semana");
define("_MI_SATURDAYCOLOR", "Color del Sábado");
define("_MI_HOLIDAYCOLOR", "Color del día festivo");
define("_MI_TARGETDAYCOLOR", "Color del día con evento");
define("_MI_SUNDAYBGCOLOR", "Color de fondo del Domingo");
define("_MI_WEEKDAYBGCOLOR", "Color de fondo de los días de la semana");
define("_MI_SATURDAYBGCOLOR", "Color de fondo del Sábado");
define("_MI_HOLIDAYBGCOLOR", "Color de fondo de los días festivos");
define("_MI_TARGETDAYBGCOLOR", "Color de fondo del día con evento");
...
define("_MI_MAXRRULEEXTRACT", "Límite superior de los eventos extraídos por regla.(CONT)");
define("_MI_WEEKSTARTFROM", "Día que comienza de la semana");
...
define('_MI_DAYSTARTFROM','Linea del borde para separar los días');
define('_MI_PICAL_GLOBAL_NOTIFY','Global');
define('_MI_PICAL_GLOBAL_NOTIFYDSC','Global piCal opciones de notificación.');
define('_MI_PICAL_CATEGORY_NOTIFY','Categoria');
define('_MI_PICAL_CATEGORY_NOTIFYDSC','Opciones de Notificación que seran aplicadas a esta categoría.');
define('_MI_PICAL_EVENT_NOTIFY','Evento');
define('_MI_PICAL_EVENT_NOTIFYDSC','Opciones de Notificación que seran aplicadas a este evento.');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFY','Nuevo Evento');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYCAP','Notificarme cuando se añada un evento.');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYDSC','Recibir una notificación cuando un envento es añadido.');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYSBJ','[{X_SITENAME}] {X_MODULE} auto-notificación : Nuevo evento');
...
define('_MI_WEEKNUMBERING','Número de divisiones por semanas');
define('_MI_OPT_MINI_LIST','lista de eventos');
define('_MI_OPT_WEEKNOEACHMONTH','por cada mes');
define('_MI_OPT_WEEKNOWHOLEYEAR','por años');
...
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFYDSC','Recibir una notificación cuando un evento haya sido creado en esta categoría.');

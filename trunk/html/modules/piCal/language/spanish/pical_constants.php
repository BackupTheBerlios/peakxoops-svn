...
define('_PICAL_FMT_YEAR','<font size="-1">AÑO </font>%s') ;

define('_PICAL_ICON_DAILY','Vista por día') ;
...
define('_PICAL_MB_PREV_DATE','Mañana') ;
...
define('_PICAL_MB_EVENT_NEEDADMIT','Esperando admisión') ;

define('_PICAL_MB_TITLE_EVENTINFO','Agenda') ;
define('_PICAL_MB_SUBTITLE_EVENTDETAIL','Vista detallada') ;
define('_PICAL_MB_SUBTITLE_EVENTEDIT','Vista de edición') ;
...
define('_PICAL_TH_ALLDAYOPTIONS','Opción de todo el día') ;
define('_PICAL_TH_LOCATION','Localización') ;
define('_PICAL_TH_CONTACT','Contacto') ;
define('_PICAL_TH_CLASS','Clase') ;
define('_PICAL_TH_DESCRIPTION','Descripción') ;
...
define('_PICAL_NTC_EXTRACTLIMIT','**Se extraen solamente %s acontecimientos como máximo') ;
define('_PICAL_NTC_NUMBEROFNEEDADMIT','(%s es el número de artículos que admite)') ;
...
define('_PICAL_CNFM_SAVEAS_YN','Estás seguro de guardar como otra entrada?') ;
define('_PICAL_CNFM_DELETE_YN','Estás seguro de borrar esta entrada?') ;
...
define('_PICAL_ERR_LACKINDISPITEM','El artículo %s está vacio.<br />Regresa haciendo click atras en tu navegador') ;
...
define('_PICAL_TH_LASTMODIFIED','Ultima modificación');

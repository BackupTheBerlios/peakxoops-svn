...
define('_AM_OPT_PAST','Förr');
define('_AM_OPT_FUTURE','Framtida');
define('_AM_OPT_PASTANDFUTURE','Förr&Framtida');

define("_AM_CONFIG","Konfigureringsmeny för piCal");
define("_AM_GENERALCONF","Generella inställningar för piCal");
define("_AM_ADMISSION","Godkänna händelser");
...
define("_AM_GROUPPERM","Grupprättigheter");
define("_AM_MYBLOCKSADMIN","piCal's Block&Grupp administration");

// forms
define("_AM_BUTTON_EXTRACT","Packa upp");
define("_AM_BUTTON_ADMIT","Godkänn");
...
// admission
define("_AM_LABEL_ADMIT","Markerade händelser kommer: att godkännas ");
define("_AM_MES_ADMITTED","Händelse(r) har godkännts");
define("_AM_ADMIT_TH0","Användare");
...
define("_AM_LABEL_IMPORTFROMWEB","Importera iCalendar data från web (Angiven URL skall starta på 'http://' eller 'webcal://')");
define("_AM_LABEL_UPLOADFROMFILE","Ladda upp iCalendar data (Välj en fil på Er lokala dator)");
define("_AM_BUTTON_IMPORT","Import!");
define("_AM_BUTTON_UPLOAD","Ladda upp!");
define("_AM_LABEL_IO_CHECKEDITEMS","Markerade händelser kommer:");
define("_AM_LABEL_IO_OUTPUT","att bli exporterade till iCalendar");
define("_AM_LABEL_IO_SELECTPLATFORM","Välj plattform");
define("_AM_LABEL_IO_DELETE","att bli raderade ");
define("_AM_MES_DELETED","Händelse(r) har raderats");
define("_AM_IO_TH0","Användare");
define("_AM_IO_TH1","Start Datum&Tid");
define("_AM_IO_TH2","Slut Datum&Tid");
define("_AM_IO_TH3","Titel");
define("_AM_IO_TH4","Regel");
define("_AM_IO_TH5","Godkända");

// Group's Permissions
define( '_AM_GPERM_G_INSERTABLE' , "Lägga Till" ) ;
define( '_AM_GPERM_G_SUPERINSERT' , "Super Lägga Till" ) ;
...
define( '_AM_GROUPPERMDESC' , "Markera vad respektive grupp har rättighet att urföra.<br />Om denna funktion används, markera 'Behörigheter för användare' till 'Specificerad i Grupprättigheterna' först i 'Inställningar'.<br />Inställningarna för grupperna 'Administrator' och 'Guest' kommer att ignoreras." ) ;
...
define('_AM_MENU_CAT2GROUP','Rättigheter för Kategorier');
define('_AM_TABLEMAINTAIN','Tabell Underhåll (Uppgradera)');
define('_AM_BUTTON_MOVE','Flytta');
define('_AM_BUTTON_COPY','Kopiera');
define('_AM_CONFIRM_MOVE','Ta bort länk till den gamla kategorin och lägg till en länk till den specificerade kategorin?');
define('_AM_CONFIRM_COPY','Lägg till en länk till specificerad länk?');
define('_AM_BUTTON_EXPORT','Exportera!');
define('_AM_MES_EVENTLINKTOCAT','händelse(r) har länkats till denna kategori');
define('_AM_MES_EVENTUNLINKED','länk till händelse(r) har tagits bort från denna kategori');
define('_AM_FMT_IMPORTED','händelse(r) har importerats från \'%s\'');
define('_AM_CAT2GROUPDESC','Markera de kategorier som respektive grupp har tillgång till');
...
define('_AM_NOTICE_NOERRORS','Det finns inga fel på tabeller eller records.');
define('_AM_ALRT_CATTABLENOTEXIST','Kategori tabellen finns inte.<br />
Vill Ni skapa tabellen?');
define('_AM_ALRT_OLDTABLE','Tabellstrukturen är gammal.<br />
Vill Ni uppgradera tabellerna?');
define('_AM_ALRT_TOOOLDTABLE','Det uppträdde ett tabell fel.<br />
Ni kanske använde piCal 0.3x eller tidigare.<br />
Uppgradera först till 0.4x eller 0.5x.');
define('_AM_FMT_WRONGSTZ','Det finns %s händelse(r) som har fel tidszon registrerad.<br />Vill Ni reparera dem?');
...
define('_AM_CAT_TH_LASTMODIFY','Senast ändrad');
...
define('_AM_MB_MAKETOPCAT','Skapa en kategori i översta nivån');

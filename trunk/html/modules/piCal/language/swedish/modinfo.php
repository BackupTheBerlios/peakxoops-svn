...
define("_MI_PICAL_BNAME_MONTHCAL","Månadskalender");
define("_MI_PICAL_BNAME_MONTHCAL_DESC","Visa Månadskalender i full storlek");
define("_MI_PICAL_BNAME_TODAYS","Dagens händelser");
define("_MI_PICAL_BNAME_TODAYS_DESC","Visa Dagens händelser");
define("_MI_PICAL_BNAME_THEDAYS","Denna dagens %s");
define("_MI_PICAL_BNAME_THEDAYS_DESC","Visa händelser för markerad dag");
define("_MI_PICAL_BNAME_COMING","Kommande händelser");
define("_MI_PICAL_BNAME_COMING_DESC","Visa kommande händelser");
define("_MI_PICAL_BNAME_AFTER","Händelser efter %s");
define("_MI_PICAL_BNAME_AFTER_DESC","Visa händelser efter markerad dag");
...
// Admin Menus
define("_MI_PICAL_ADMENU0","Godkänna händelser");
define("_MI_PICAL_ADMENU1","iCalendar I/O");
define("_MI_PICAL_ADMENU2","Grupp rättigheter");


// Text for notifications
define('_MI_PICAL_GLOBAL_NOTIFY', 'Globala');
define('_MI_PICAL_GLOBAL_NOTIFYDSC', 'Globala piCal underrättelse inställningar.');
define('_MI_PICAL_CATEGORY_NOTIFY', 'Kategori');
define('_MI_PICAL_CATEGORY_NOTIFYDSC', 'Underrättelse inställningar som gäller för aktuell kategori.');
define('_MI_PICAL_EVENT_NOTIFY', 'Händelse');
define('_MI_PICAL_EVENT_NOTIFYDSC', 'Underrättelse inställningar som gäller för aktuell händelse.');

define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFY', 'Ny händelse');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYCAP', 'Underrätta mig när en ny händelse har skapats.');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYDSC', 'Mottag underrättelse när en ny händelse har skapats.');
define('_MI_PICAL_GLOBAL_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} automatiska underrättelser : Ny händelse');



// Appended by Xoops Language Checker -GIJOE- in 2004-01-14 18:31:01
define('_MI_PICAL_BNAME_NEW','Nyligen publicerade händelser');
define('_MI_PICAL_BNAME_NEW_DESC','Visa händelser sorterade med nyaste överst');
define('_MI_PICAL_SM_SUBMIT','Lägg till');
...
define('_MI_PICAL_ADMENU_CAT2GROUP','Rättigheter för Kategorier');
define('_MI_PICAL_ADMENU_TM','Tabell Underhåll');
define('_MI_PICAL_ADMENU_ICAL','Importera iCalendar');
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFY','Ny händelse i denna kategori');
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFYCAP','Meddela mig när en ny händelse är skapad i denna kategori.');
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFYDSC','Mottag underrättelse när en ny händelse är skapad i denna kategori.');
define('_MI_PICAL_CATEGORY_NEWEVENT_NOTIFYSBJ','[{X_SITENAME}] {X_MODULE} auto-notify : Ny händelse');

...
define("_MI_PROTECTOR_DESC","Dieses Modul schó’zt vor Angriffen auf Ihre Xoops-Seite (DoS , SQL Injection , und Variables contaminations)<br />Sie mó‘sen diesen Block oben links anzeigen lassen und den anonymen Usern den Zugriff auf diesen Block gestatten.");
...
// Configs
define('_MI_PROTECTOR_HIJACK_DENYGP','Gruppen denen das Áœdern der IP innerhalb einer Session untersagt wird.');
define('_MI_PROTECTOR_HIJACK_DENYGPDSC','Anti Session Hi-Jacking:<br />WÁ…len sie Gruppen aus, denen es untersagt ist, ihre IP wÁ…rend einer Session zu Áœdern..<br />(Mindestens Administrator-Gruppe wird empfohlen.)');
define('_MI_PROTECTOR_SAN_NULLBYTE','Sanitizing (SÁ÷berung) null-bytes');
...
define('_MI_PROTECTOR_DIE_BADEXT','Beenden, wenn unzulÁ‘sige Dateien hochgeladen werden');
define('_MI_PROTECTOR_DIE_BADEXTDSC','Wenn jemand versucht, Dateien mit unzulÁ‘sigen Endungen wie .php hochzuladen, beendet diese Modul den Zugriff auf XOOPS.<br />Wenn Sie oft Dateien in B-Wiki oder PukiWikiMod einstellen, schalten Sie diese Option aus.');
define('_MI_PROTECTOR_CONTAMI_ACTION','Massnahmen, wenn eine Verunreinigung gefunden wurde:');
define('_MI_PROTECTOR_CONTAMI_ACTIONDS','WÁ…len Sie eine Aktion aus, wenn jemand versucht, globale XOOPS-Variablen zu verunreinigen.<br />(Empfohlen wird "Weisser Bildschirm")');
define('_MI_PROTECTOR_ISOCOM_ACTION','AMassnahmen, wenn eine isolierte Einkommentierung gefunden wurde:');
define('_MI_PROTECTOR_ISOCOM_ACTIONDSC','Anti SQL Injection:<br />WÁ…len Sie eine Massnahme aus, die ergriffen wird, wenn ein  isoliertes "/*" gefunden wird.<br />"Sanitizing (SÁ÷berung)" bedeutet, ein zusÁ’zliches  "*/" anzuhÁœgen.<br />(Empfohlen wird "Sanitizing (SÁ÷berung)" )');
define('_MI_PROTECTOR_UNION_ACTION','Massnahme wenn ein UNION gefunden wurde.');
define('_MI_PROTECTOR_UNION_ACTIONDSC','Anti SQL Injection:<br />WÁ…len sie eine Massnahme, wenn ein SQL-Befehl wie UNION gefunden wurde.<br />"Sanitizing (SÁ÷berung)" bedeutet die éƒnderung von "union" nach "uni-on".<br />(Empfohlen wird Sanitizing (SÁ÷berung))');
define('_MI_PROTECTOR_ID_INTVAL','Erzwinge intval fó” Variablen wie IDé¥s');
define('_MI_PROTECTOR_ID_INTVALDSC','Alle Anfragen mit Namen "*id" Werden als Integer behandelt.<br />Diese Option beschó’zt sie vor einigen Arten der XSS-(Cross Site Scripting-) und SQL-Injection-Attacken.<br />Obwohl empfohlen wird, diese Option einzuschalten, kann es in einigen Modulen Probleme damit geben.');
...
define('_MI_PROTECTOR_DOS_EXPIRE','Zeitlimit fó” hohe Serverlast (sec)');
define('_MI_PROTECTOR_DOS_EXPIREDSC','Dieser Wert gibt das Zeitlimit fó” rasch wiederholte reloads der Seite (F5 Attacke) und fó” Suchmaschinen mit hoher Last an.');

define('_MI_PROTECTOR_DOS_F5COUNT','Anzahl als schÁ≈lich eingestufter Reloads');
...
define('_MI_PROTECTOR_DOS_CRCOUNT','Anzahl als schÁ≈lich eingestufter Suchmaschinen-Abfragen');
define('_MI_PROTECTOR_DOS_CRCOUNTDSC','Schó’zt vor Server-intensiven Abfragen durch Suchmaschinen.<br />Dieser Wert gibt an, wieviele Zugriffe als Server-intensiv eingestuft werden.');
...
define('_MI_PROTECTOR_DOS_CRSAFEDSC','Ein regulÁ”er Perl-Ausdruck fó” User-Agents.<br />Wenn der Ausdruck zutrifft, wird die Suchmaschine niemals als Server-intensiv eingestuft.<br />Bsp: (msnbot|Googlebot|Yahoo! Slurp)/i');

define('_MI_PROTECTOR_OPT_NONE','Keine (nur logging)');
define('_MI_PROTECTOR_OPT_SAN','Sanitizing (SÁ÷berung)');
...
define('_MI_PROTECTOR_PATCH2092','Spezielle Massnahmen fó” XOOPS <= 2.0.9.2');

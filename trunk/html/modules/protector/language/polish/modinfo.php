...
define('_MI_PROTECTOR_RELIABLE_IPSDSC','Wprowad¼ adresy IP godne zaufania oddzielaj±c je | . ^ zastêpuje pocz±tek ci±gu cyfr, $ zastêpuje koniec ci±gu cyfr.');
...
define('_MI_PROTECTOR_HIJACK_TOPBIT','Zabezpieczenie bitów IP dla sesji.');
define('_MI_PROTECTOR_HIJACK_TOPBITDSC','Zabezpieczenie przed kradzie¿± sesji:<br />Domy¶lnie 32(bit). (Wszystkie bity zabezpieczone)<br />Je¶li Twoje IP nie jest sta³e, ustaw zakres IP.<br />(n.p.) Je¶li Twoje IP mo¿e zmieniaæ siê w zakresie 192.168.0.0-192.168.0.255, ustaw tutaj 24 bity');
...
define('_MI_PROTECTOR_FILE_DOTDOT','Zabezpieczenie przed wêdrowaniem po katalogach');
define('_MI_PROTECTOR_FILE_DOTDOTDSC','Usuwa ".." z wszystkich zapytañ wygl±daj±cych jak szperanie po katalogach');
define('_MI_PROTECTOR_BF_COUNT','Zabezpieczenie przed atakiem Brute Force');
define('_MI_PROTECTOR_BF_COUNTDSC','Ustal ilo¶æ dozwolonych prób logowania u¿ytkownika w ci±gu 10 minut. Je¶li kto¶ bêdzie próbowa³ logowaæ siê wiêcej razy w tym czasie, jego IP zostanie zbanowane.');

define('_MI_PROTECTOR_DOS_SKIPMODS','Modu³y nie podlegaj±ce zabezpieczeniu anty DoS');
define('_MI_PROTECTOR_DOS_SKIPMODSDSC','wpisz nazwy katalogów wy³±czonych modu³ów oddzielone |. Opcja u¿yteczna dla modu³u czata itp.');

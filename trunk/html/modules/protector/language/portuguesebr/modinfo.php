...
define("_MI_PROTECTOR_DESC","Módulo para proteção do XOOPS contra ataques mal-intencionados, em especial: ataques DoS, SQL Injection e contaminações por variá×el.");
...
define("_MI_PROTECTOR_RELIABLE_IPSDSC","Indique os endereços IP que não passarão por examinação para ataques DoS, separados por |. ^ para o inválido, e  $ para o final do string.");
...
define("_MI_PROTECTOR_HIJACK_TOPBIT","Proteção de IP bits contra renovação de sessão");
define("_MI_PROTECTOR_HIJACK_TOPBITDSC","Prevenção à session hijack:<br />O padrão é 32(bit) e protege de todos os bits.<br />Caso use Proxy ou seu endereço IP mude a cada acesso, defina o intervalo de bits mais longo possível à invariação.<br />Ex.: Se houver possibilidade de variação dentro de 192.168.0.0~192.168.0.255, defina esta opção como 24(bit).");
...
define("_MI_PROTECTOR_SAN_NULLBYTEDSC","O caracter \"\\0\" fatal é usado freqüentemente em ataques maliciosos.<br />Sempre que detectado, ele será substituição por um espaço.<br />(Recomendado)");
define("_MI_PROTECTOR_DIE_NULLBYTE","Encerramento forçado de sessão em caso de detecção de caracteres nulos");
define("_MI_PROTECTOR_DIE_NULLBYTEDSC","O caracter \"\\0\" fatal é usado frequentemente em ataques maliciosos.<br />(Recomendado)");
...
define("_MI_PROTECTOR_ISOCOM_ACTIONDSC","Prevenîåo à SQL injection:<br />Escolha o tipo de solução quando um comentário isolado /* for detectado sem seu par */.<br />Processo de sanitização: */ é inserido no final.<br />(Recomendado: \"Sanitização\")");
define("_MI_PROTECTOR_UNION_ACTION","Solução em caso de detecção de UNION");
define("_MI_PROTECTOR_UNION_ACTIONDSC","Prevenção à SQL injection:<br />Escolha o tipo de soluîåo quando uma sintaxe UNION do SQL for detectada.<br />Processo de sanitizaîåo: UNION é alterado para uni-on.<br />(Recomendado: \"Sanitizaîåo\")");
define("_MI_PROTECTOR_ID_INTVAL","Conversão forçada de variável ID");
define("_MI_PROTECTOR_ID_INTVALDSC","Força valores numéricos e variáveis com nomes terminados em \"id\". É eficaz, principalmente, com módulos derivados do myLinks. Protege também de alguns XSS e SQL injection. Entretanto, pode entrar em conflito com alguns módulos.");
define("_MI_PROTECTOR_FILE_DOTDOT","Proibido de DirectoryTraversal");
...
define("_MI_PROTECTOR_DOS_EXPIREDSC","Tempo de observação para acompanhar a frequência dos acessos de DoS e crawlers maliciosos.");

define("_MI_PROTECTOR_DOS_F5COUNT","Nº de vezes para ser reconhecido como ataque F5");
define("_MI_PROTECTOR_DOS_F5COUNTDSC","Defesa contra ataques DoS:<br />Se houver muitos acessos à uma mesma URL dentro do tempo de observação definido acima e do nº de vezes definidas nesta opîåo, será reconhecido como um ataque.");
...
define("_MI_PROTECTOR_DOS_CRCOUNTDSC","Prevenção à crawlers maliciosos (como bots catadores de e-mails):<br />Se forem realizadas buscas dentro do site dentro do tempo de observação definido acima e do nº de vezes definidas nesta opção, será reconhecido como um crawler malicioso.");
...
define("_MI_PROTECTOR_BIP_EXCEPTDSC","Mesmo quando a condição for satisfeita, os usuários dos grupos indicados nesta opção nãp serão adicionados à lista de IPs banidos. Entretanto, se estes usuários não fizerem login, o efeito desta opção será anulado. TENHA CUIDADO!<br />(Recomendado: \"Administradores\")");
define("_MI_PROTECTOR_DISABLES","Desativar opções inseguras");
define("_MI_PROTECTOR_PASSWD_BIP","Senha de restauração");
define("_MI_PROTECTOR_PASSWD_BIPDSC","Esta é a forma de restauração se, por alguma razão, você mesmo for adicionado à lista de IPs banidos do XOOPS.<br />Acesse XOOPS_URL/modules/protector/admin/rescue.php, e insira a senha definida aqui.<br />Caso nenhuma senha seja definida nesta opção, o efeito dela será anulado. TENHA CUIDADO!<br />Esta senha será armazenada sem encriptaçãoo, alguém pode acabar tendo acesso à ela. Por isso, nunca utilize senhas importantes.");
?>

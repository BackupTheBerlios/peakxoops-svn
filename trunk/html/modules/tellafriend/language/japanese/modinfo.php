...
define( "_MI_TELLAFRIEND_INVALIDMAILFROM" , "あなたのメールアドレスが無効です" ) ;
define( "_MI_TELLAFRIEND_INVALIDMAILTO" , "宛先に無効なメールアドレスが指定されました" ) ;
// %s is user's name
define( "_MI_TELLAFRIEND_MAILBODYNAME" , "%s さんからの紹介メールです\n" ) ;
...
define( "_MI_TELLAFRIEND_FORMTHFROMEMAIL" , "あなたのメールアドレス" ) ;
define( "_MI_TELLAFRIEND_FORMTHTO" , "紹介する相手のメールアドレス" ) ;
define( "_MI_TELLAFRIEND_FORMTHSUBJ" , "メールのタイトル" ) ;
define( "_MI_TELLAFRIEND_FORMTHBODY" , "本文" ) ;

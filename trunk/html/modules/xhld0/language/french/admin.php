...
define('_AM_ENCODING_AUTO',"auto dñÕection") ;

define("_AM_DBUPDATED","Base de donnñÆs mise à jour avec succïÔ!");
...
define('_AM_URL','URL');
define('_AM_TITLEPATTERN','Extraire avec la chaine du titre<br /><span style="font-weight:normal;">ñÄrire ici une expression rñÈuliïÓe perl /doller/<br />Normalement, laisser à blanc</span>');
...
define('_AM_LINKPATTERN','Extraire avec la chaine du titre<br /><span style="font-weight:normal;">ñÄrire ici une expression rñÈuliïÓe perl /business/<br />Normalement, laisser à blanc</span>');
...
define('_AM_TIMEOUT', "Time-out lors de l'intñÈration de la news");
...
define('_AM_MAINSETT', 'ParamñÕrage de la page principale');
define('_AM_BLOCKSETT', 'ParamñÕrage des Blocs');
...
define('_AM_UPDATE','MAJ et reintñÈrer');
...
define('_AM_FAILUPDATE', 'Echec de la sauvegarde des donnñÆs pour la base de donnñÆ du flux headline %s');
define('_AM_FAILDELETE', 'Echec de la suppression des donnñÆs pour la base de donnñÆ du flux headline %s');

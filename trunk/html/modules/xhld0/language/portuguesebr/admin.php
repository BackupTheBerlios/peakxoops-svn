...
// Appended by Xoops Language Checker -GIJOE- in 2005-02-21 05:58:22
...
define('_AM_URL','URL');
define('_AM_TITLEPATTERN','Exibir os que contñÎ a palavra no tùÕulo<br /><span style="font-weight:normal;">escreva aqui uma expressåÐ regular do perl. (ex: /dinheiro/)<br />Normalmente, deixe em branco</span>');
define('_AM_LINKPATTERN','Exibir os que contñÎ a palavra no link<br /><span style="font-weight:normal;">escreva aqui uma expressåÐ regular do perl. (ex: /novidades/)<br />Normalmente, deixe em branco</span>');
define('_AM_ORDER', 'Ordem');
define('_AM_ENCODING', 'Codificaîåo RSS');
define('_AM_CACHETIME', 'Tempo em cache');
define('_AM_TIMEOUT', 'Time-out da busca');
define('_AM_ALLOWHTML', 'Permitir HTML dentro do XML<br /><span style="font-weight:normal;">Você nåÐ deve permitir HTML para um RSS/ATOM quando este é gerado pelos posts dos visitantes do site.</span>');
define('_AM_MAINSETT', 'Configuraîåo da páÈina principal');
define('_AM_BLOCKSETT', 'Configuraîåo dos blocos');
define('_AM_DISPIMG', 'Exibir imagens');
define('_AM_DISPFULL', 'Exibir descriîåo e data de publicaîåo');
define('_AM_DISPMAX', 'Quantidade máÙima de itens a exibir');
define('_AM_DISPLAY', 'Exibir na PáÈina Principal');
...
define('_AM_INVALIDID', 'ID InváÍido');
define('_AM_OBJECTNG', 'Objeto nåÐ existe');
define('_AM_FAILUPDATE', 'Impossù×el incluir %s no banco de dados');
define('_AM_FAILDELETE', 'Impossù×el excluir a manchete %s do banco de dados');

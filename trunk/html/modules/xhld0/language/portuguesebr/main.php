...
define('_HL_DESCRIPTION', 'Descriзгo');
define('_HL_WEBMASTER', 'Webmaster');
define('_HL_CATEGORY', 'Categoria');
define('_HL_GENERATOR', 'Emissor');
define('_HL_TITLE', 'Tнtulo');
define('_HL_PUBDATE', 'Publicado');
define('_HL_FAILGET', 'Impossнvel acessar RSS feed de %s, neste momento.');
define('_HL_GOTOTOP', 'Voltar ao нnicio');

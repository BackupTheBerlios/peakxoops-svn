...
define('_AM_DBUPDATED','Ž¿Base de Datos Actualizada Correctamente!');
define('_AM_HEADLINES','Configuraci…Ï de los Titulares (No.%s)');
define('_AM_HLMAIN','Titular Principal');
define('_AM_SITENAME','Nombre del Sitio');
define('_AM_URL','URL');
define('_AM_TITLEPATTERN','Extraer con texto de tùÕulo<br /><span style="font-weight:normal;">escriva aquí una expresi…Ï regular de perl ej.) /dolar/</span>');
define('_AM_LINKPATTERN','Extraer con texto de enlace<br /><span style="font-weight:normal;">escriva aquí uma expresi…Ï regular de perl ej.) /negocios/</span>');
define('_AM_ORDER', 'Orden');
define('_AM_ENCODING', 'Codificaci…Ï RSS');
...
define('_AM_MAINSETT', 'Configuraciones de PáÈina Principal');
define('_AM_BLOCKSETT', 'Configuraciones de Bloque');
define('_AM_DISPLAY', 'Mostrar en páÈina principal');
define('_AM_DISPIMG', 'Mostrar imáÈem');
define('_AM_DISPFULL', 'Exibir descripci…Ï y fecha de publucaci…Ï tambiñÏ');
define('_AM_DISPMAX', 'MáÙ elementos a mostrar');
define('_AM_ASBLOCK', 'Mostrar en bloque');
define('_AM_ADDHEADL','AÂdir Titular');
...
define('_AM_WANTDEL','Está seguro que desea borrar el titular para %s?');
define('_AM_INVALIDID', 'ID InváÍido');
define('_AM_OBJECTNG', 'Objeto no existe');
define('_AM_FAILUPDATE', 'Fallo al guardar informaci…Ï en la base de datos para el titular %s');
define('_AM_FAILDELETE', 'Fallo al borrar informaci…Ï de la base de datos para el titular %s');

...
define("_MI_HEADLINES_INDEX_VIEWMODED","Seleccione un tipo de vista para el tope del módulo");
define("_MI_HEADLINES_INDEX_VIEWMODE_MIXED","Mezclados & Más nuevos arriba");
define("_MI_HEADLINES_INDEX_VIEWMODE_CLASSIC","Clásico");
define("_MI_HEADLINES_MIXED_MAXITEM","Máx elementos");
...
define("_MI_HEADLINES_PROXY_PORTD","Si optiene los RSS/RDF mediante un servidor proxy, ponga el número de puerto aquí") ;
define("_MI_HEADLINES_PROXY_USER","Usuario Proxy");
define("_MI_HEADLINES_PROXY_USERD","Si su servidor proxy necesita autenticación BÁSICA, ponga el nombre del usuario<br />Si no, dejar en blanco") ;
define("_MI_HEADLINES_PROXY_PASS","Password Proxy");
define("_MI_HEADLINES_PROXY_PASSD","Si su servidor proxy necesita autenticación BÁSICA, ponga el password<br />Si no, dejar en blanco") ;

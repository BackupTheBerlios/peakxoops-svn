<?php
// $Id: pagenav.php,v 1.9 2004/08/17 03:29:50 skalpa Exp $
//  ------------------------------------------------------------------------ //
...
class XhXoopsPageNav
{
	 ...
	 **/
	function XhXoopsPageNav($base_url, $total_items, $items_perpage, $current_start, $start_name="start", $extra_arg="")
	{

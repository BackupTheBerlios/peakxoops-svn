...
define("_MI_XHNEWBB_BNAME1","フォーラムでの最近の投稿");
define("_MI_XHNEWBB_BNAME2","フォーラムでの参照数の多い話題");
define("_MI_XHNEWBB_BNAME3","フォーラムでの発言数の多い話題");
define("_MI_XHNEWBB_BNAME4","プライベートフォーラムでの投稿");

define("_MI_XHNEWBB_ADMENU1","フォーラムの追加");
define("_MI_XHNEWBB_ADMENU2","フォーラムの編集");
define("_MI_XHNEWBB_ADMENU3","プライベートフォーラムの設定");
define("_MI_XHNEWBB_ADMENU4","スレッド投稿数の再集計");
...
define ('_MI_XHNEWBB_THREAD_NOTIFY', '表示中のスレッド'); 
define ('_MI_XHNEWBB_THREAD_NOTIFYDSC', '表示中のスレッドに対する通知オプション');
...
define ('_MI_XHNEWBB_THREAD_NEWPOST_NOTIFYCAP', 'このスレッドにおいて返信が投稿された場合に通知する');
define ('_MI_XHNEWBB_THREAD_NEWPOST_NOTIFYDSC', 'このスレッドにおいて返信が投稿された場合に通知する');
define ('_MI_XHNEWBB_THREAD_NEWPOST_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE}: スレッド内に返信が投稿されました');

define ('_MI_XHNEWBB_FORUM_NEWTHREAD_NOTIFY', '新規スレッド');
define ('_MI_XHNEWBB_FORUM_NEWTHREAD_NOTIFYCAP', 'このフォーラムにおいて新規スレッドの投稿があった場合に通知する');
define ('_MI_XHNEWBB_FORUM_NEWTHREAD_NOTIFYDSC', 'このフォーラムにおいて新規スレッドの投稿があった場合に通知する');
define ('_MI_XHNEWBB_FORUM_NEWTHREAD_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE}: 新規スレッドが投稿されました');
...
define ('_MI_XHNEWBB_GLOBAL_NEWPOST_NOTIFYCAP', '新規スレッドまたは返信の投稿があった場合に通知する');
define ('_MI_XHNEWBB_GLOBAL_NEWPOST_NOTIFYDSC', '新規スレッドまたは返信の投稿があった場合に通知する');
...
define ('_MI_XHNEWBB_GLOBAL_NEWFULLPOST_NOTIFYCAP', '新規スレッドまたは返信の投稿があった場合に通知する（投稿文付き）');
define ('_MI_XHNEWBB_GLOBAL_NEWFULLPOST_NOTIFYDSC', '新規スレッドまたは返信の投稿があった場合に通知する（投稿文付き）');

...
// プラグインファイル名を取得
$plugin_path = XOOPS_ROOT_PATH.'/modules/xmobile/plugins/';
if (is_dir($plugin_path))
{
	...
	{
		$file = preg_replace("/^(\w+)\.php/","$1",$file);
...
foreach($mids as $mid)
{
	...
	$module_name = $module->getVar('name','n'); // GIJ
...
{
	$sql = "INSERT INTO ".$xoopsDB->prefix('configoption')." (conf_id, confop_name, confop_value) "." VALUES (".$conf_id.",'".addslashes($confop_name)."','".addslashes($confop_value)."')"; // GIJ

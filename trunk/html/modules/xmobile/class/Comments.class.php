...
//		include_once XOOPS_ROOT_PATH.'/modules/system/constants.php';
		...
		$this->module = $this->pluginHandler->getModuleObject(); // GIJ
		$this->mid = $this->pluginHandler->getMid();
		$this->module_config = $this->pluginHandler->getModuleConfig(); // GIJ
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function checkCommentRule()
	{
		...
		if(@$this->module_config['com_rule'] != XOOPS_COMMENT_APPROVENONE) // GIJ
		{
...
//		$comments = $comment_handler->getByItemId($this->mid, $this->com_itemid, $this->com_dborder, null, $xoopsModuleConfig['comment_title_row'], $pageNavi->getStart());
		...
		foreach($comments as $comment)
		{
			...
			$html_ret .= _CM_POSTED.'：'.strftime('%Y-%m-%d %H:%M',$com_created).'<br />';

...
/*
		...
		$this->categoryTableName = 'cclinks'.$dirnumber.'_cats';
		$this->itemTableName = 'cclinks'.$dirnumber.'_links';
*/
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// ただし、戻り値はオブジェクトではなく配列
	function getRecentList()
	{
		...
		{
//			$this->utils->setDebugMessage(__CLASS__, '　なし');
...
//		$this->utils->setDebugMessage(__CLASS__, '　あり');

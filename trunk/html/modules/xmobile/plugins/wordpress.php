...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class XmobileWordpressPlugin extends XmobilePlugin
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class XmobileWordpressPluginHandler extends XmobilePluginHandler
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		$sql = 'SELECT category_id FROM '.$this->db->prefix('wp_post2cat').' WHERE post_id ='.$id;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function getChildItemCountById($id)
	{
		...
		$sql = 'SELECT post_id FROM '.$this->db->prefix('wp_post2cat').' WHERE category_id IN('.$ids.')';
		// debug

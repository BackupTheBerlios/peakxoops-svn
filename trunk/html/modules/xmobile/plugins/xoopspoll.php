...
// ただし、戻り値はオブジェクトではなくHTML
	function getItemDetail()
	{
		...
		// 投票
			...
			$detail4html .= sprintf(_MD_XMOBILE_VOTE_END,strftime('%Y-%m-%d %H:%M',$end_time)).'<br />';
			$detail4html .= _MD_XMOBILE_WAIT_VOTE_END.'<br />';
		}
		else
		{
		// 集計結果
			$detail4html .= sprintf(_MD_XMOBILE_VOTE_ALREADY_END,strftime('%Y-%m-%d %H:%M',$end_time)).'<br />';

...
CREATE TABLE categories (
  ...
  cat_path_in_tree text NOT NULL default '',
  cat_unique_path text NOT NULL default '',
  cat_weight smallint(5) NOT NULL default 0,
  cat_options text NOT NULL default '',
  PRIMARY KEY (cat_id),
  KEY (cat_weight),
  KEY (pid)
) TYPE=MyISAM;
...
CREATE TABLE forums (
  ...
  forum_options text NOT NULL default '',
...
CREATE TABLE posts (
  ...
  hide_uid tinyint(1) NOT NULL default 0,
  ...
  path_in_tree text NOT NULL default '',
  unique_path text NOT NULL default '',

...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return dbtheme_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'dbtheme_onuninstall_base' ) ) {

function dbtheme_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'dbtheme_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function dbtheme_message_append_onuninstall( &$module_obj , &$log )
{

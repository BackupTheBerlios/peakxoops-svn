...
function b_pico_list_show( $options )
{
	...
	$sql = "SELECT o.content_id,o.subject,o.created_time,o.modified_time,o.poster_uid,c.cat_title FROM ".$db->prefix($mydirname."_contents")." o LEFT JOIN ".$db->prefix($mydirname."_categories")." c ON o.cat_id=c.cat_id WHERE ($whr_read4cat) AND ($whr_categories) AND o.visible ORDER BY $selected_order,o.content_id LIMIT $contents_num" ;

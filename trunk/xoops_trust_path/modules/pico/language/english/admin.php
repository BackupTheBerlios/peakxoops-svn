...
define('_MD_A_PICO_CONFIRM_DELETE','If you want to access them from deleted contetents in the future, delete from content manager. Are you sure to delete them?');

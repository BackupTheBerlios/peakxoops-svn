...
define('_MD_PICO_FORMMAIL_ERRFMT_MISSING_SELECTED','<li>Selectionner un pour %s</li>') ;
define('_MD_PICO_FORMMAIL_ERRFMT_ATLEAST_ONE','<li>Selectionner au moins un pour %s</li>') ;

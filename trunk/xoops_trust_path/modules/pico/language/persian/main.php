...
define('_MD_PICO_FILTERS_WRAPSTITLE','پنهان سازي صفحه(نکته:فايل مشخص شده در مسير مجازي در عوض بدنه نشان داده مي شود)');
define('_MD_PICO_FILTERS_WRAPSDESC','فایل های هدف در شاخه ی XOOPS_TRUST_PATH/wraps/(dirname)/file قرار دارند');
